-- Reset Sprint 3 : données réalistes malagasy + pièces justificatives
...
-- Dossiers (scan_termine = false par défaut, sauf dossier 1 qui est verrouillé)
...
-- Note : les pièces justificatives sont des fichiers scannés,
-- elles seront ajoutées via l'interface d'upload du backoffice.
-- La table piece_justificative est créée automatiquement par JPA (ddl-auto=update).
