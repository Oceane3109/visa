-- Reset Sprint 4 : données réalistes malagasy + support frontend React
...
SELECT setval(pg_get_serial_sequence('piece_justificative', 'id'), 1, false);

-- Dossiers
INSERT INTO dossier (id, numero_dossier, date_creation, passeport_numero, nom, prenom, nationalite, scan_termine) VALUES
(1, 'DOS-202604-0001', '2026-04-10 08:30:00', 'MG-2024-00451', 'RAKOTOMALALA', 'Andrianaivo', 'Malgache', true),
(2, 'DOS-202604-0002', '2026-04-12 10:15:00', 'MG-2023-01287', 'RASOAMANANA', 'Volatiana', 'Malgache', false),
(3, 'DOS-202604-0003', '2026-04-18 14:00:00', 'MG-2022-00893', 'ANDRIANTSITOHAINA', 'Fenosoa', 'Malgache', false);

SELECT setval(pg_get_serial_sequence('dossier', 'id'), 3);

-- Demandes (variété de statuts, objectifs, passeports pour tester la recherche)
...
-- Passeports pour tester la recherche frontend :
-- MG-2024-00451 : 1 demande (DUPLICATA_CARTE, APPROUVEE, dossier 1)
-- MG-2023-01287 : 1 demande (TRANSFERT_VISA, APPROUVEE, dossier 2)
-- MG-2022-00893 : 1 demande (DUPLICATA_CARTE, APPROUVEE, dossier 3)
-- MG-2025-00234 : 1 demande (CARTE_RESIDENT, VALIDEE, pas de dossier)
-- MG-2024-01102 : 1 demande (VISA, EN_COURS, pas de dossier)
-- MG-2025-00678 : 1 demande (CARTE_RESIDENT, SOUMISE, pas de dossier)
-- MG-2024-00999 : 1 demande (VISA, REJETEE, pas de dossier)
-- MG-2025-01450 : 1 demande (CARTE_RESIDENT, INCOMPLETE, pas de dossier)
-- MG-2025-01600 : 1 demande (VISA, SOUMISE, pas de dossier)
-- MG-2024-01800 : 1 demande (CARTE_RESIDENT, EN_COURS, pas de dossier)
